...
| M7 | Trials + enquiries | Trial flow, approaches | Definer writes stay; API exposes them |
| M8 | Profile writes — seeker, provider, organiser | Onboarding | Write path; validate in DTOs, keep RLS underneath |
